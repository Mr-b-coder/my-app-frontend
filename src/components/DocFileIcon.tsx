...
const DocFileIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
  ...
  >
    ...
    <text x="50%" y="58%" dominantBaseline="middle" textAnchor="middle" fontSize="6.5" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">
      DOC
    </text>
  </svg>
);

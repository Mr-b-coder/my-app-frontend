...
const AccordionItem: React.FC<AccordionItemProps> = ({ title, children, isOpen, onToggle }) => (
  <div className="border border-border-color dark:border-dark-border-color rounded-md"> {/* border */}
    <h2>
      <button
        type="button"
        className="flex items-center justify-between w-full p-4 font-medium text-left text-text-primary dark:text-dark-text-primary bg-bg-tertiary dark:bg-dark-bg-secondary hover:bg-grey-200 dark:hover:bg-grey-700 focus:outline-none focus-visible:ring focus-visible:ring-brand-orange dark:focus-visible:ring-offset-dark-bg-secondary focus-visible:ring-opacity-75" // textPrimary, background, lighter blue hover, accent ring
        onClick={onToggle}
    ...
    {isOpen && (
      <div className="p-4 text-sm text-grey-500 dark:text-grey-400 bg-bg-secondary dark:bg-dark-bg-secondary border-t border-border-color dark:border-dark-border-color"> {/* textSecondary, surface, border */}
        {children}
      </div>
    )}
  </div>
